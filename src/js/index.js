    ...
    case 'slide_back_btn':
      try
      {
        parent.sunny.get_prev_slideID(function(slideId){
          ...
          if(slideId != -1)
          {
            parent.sunny.find_comment_from_spreadsheet_using_google_slideID(slideId,function(info){
              if(info.length==0)
              {
                 ...
                 parent.sunny.update_main_slide_image(slideId, null,parent.main_iframe,"image_content","chat_boxID","chat_box_name","chat_box_comment","chat_profileID");
                 //return;
              }
              else
              {
                ...
                parent.sunny.update_main_slide_image(slideId, info[0],parent.main_iframe,"image_content","chat_boxID","chat_box_name","chat_box_comment","chat_profileID");
              }
